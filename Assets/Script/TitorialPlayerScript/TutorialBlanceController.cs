...
public class TutorialBlanceController : MonoBehaviour
{
    // ======================================================================================
    ...
    public TutorialPlayerModesAndVisuals _modesAndVisuals;
    ...
    private void PerformAttack()
    {
        ...
        {
            case TutorialPlayerModesAndVisuals.WeaponMode.Attack1:
                StartCoroutine(HandleComboAttackRoutine());
                break;
            case TutorialPlayerModesAndVisuals.WeaponMode.Attack2:
